...
So, "GitHub has recommended Gemcutter":http://github.com/blog/515-gem-building-is-defunct as an alternative to hosting gems on GitHub. There of course, seems to be an outcry, for three main reasons that I can see:
...
Regarding RubyGem forking, I'd like to state that this statement is *false*. Gemcutter accepts built gems, so you simply need to mimic the actions that GitHub's gem builder did: Open your .gemspec up, append your username to the name, and save. @gem build@, @gem push@, and done.
