...
So, "GitHub has recommended Gemcutter":http://github.com/blog/515-gem-building-is-defunct as an alternative to hosting gems on GitHub. There of course, seems to be an outcry, for two main reasons that I can see:
