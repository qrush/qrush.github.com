...
Awesome! But these have been around for a while in Rails, and it's about damn time you start using them properly. There's also some other helpful methods on the @Rails@ module we'll explore in this post.
...
I'm sure some are missing here, but these are the ones that I think matter most to Rails developers. If something else should be covered here, let me know!
